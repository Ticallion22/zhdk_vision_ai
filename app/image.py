...
class Image:
    ...
    def annotate_image(self):
        ...
        self._image_annotation = image_annotator.annotate_from_content(self._image_content)

    def save_annotation(self):
        raw_storage_client = get_raw_storage_client()
        annotations_path = f'{self._raw_path}/annotations.json'
        raw_storage_client.upload_blob_from_content(annotations_path, self._image_annotation, content_type='application/json')
